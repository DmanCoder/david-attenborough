...
// const findCurrentGalleryItem = (state) => {
//   const glItem = gsap.utils.toArray('.banner__gallery-item');
//   const item = glItem.find((item) => {
//     const classesArr = item.classList;
//     return classesArr.value.includes(state.elementST);
//   });
...
//   const glFirst = findCurrentGalleryItem(state);
...
//   glItem.forEach((gallery) => {
//     console.log(gallery);
//     const glGalleryRect = gallery.getBoundingClientRect();
//     gsap.set(gallery, { css: {position: 'fixed', x:} });
//   }); // here
...
//   // Collect image gallery to array
//   let glItem = gsap.utils.toArray('.banner__gallery-item');

//   // Get the first index of the array
//   const glFirst = findCurrentGalleryItem(state);
//   glItem = glItem.filter((item) => item !== glFirst);
//   console.log(glItem);
//   console.log(glFirst);
...
//           gsap.set(glFirst, {
//             x: posX + spacing + glLastRect.width,
//           });
//         },
//       },
//       0
...
//   const [docType, setDocType] = useState('dolphins');
...
//       setUpAndPositionPoster({ elementST: docType, fnc: setDocType });
...
//       // loadingAnimation(
//       //   { elementST: docType, fnc: setDocType },
...
//             {galleryElementArr.map((poster, index) => poster)}
//           </div>
